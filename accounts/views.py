      ...
      if request.POST['password1'] == request.POST['password2']:
         try:
            ...
            return redirect('home')
              ...
              return render(request,'accounts/signupaccount.htmll',{'form':UserCreateForm,'error':'Username already taken. Choose new username.'})
...
def loginaccount(request):
   ...
   if request.method == 'GET':
         ...
         if user is None:
            return render(request,'accounts/loginaccount.html',{'form': AuthenticationForm(),'error': 'username and password donot match'})
